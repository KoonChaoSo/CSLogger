...
/////////////////////////// 测试
#define CSLOG_TEST_FLAG   (1000)
#define CSLOG_TEST_LEVEL   (SHLOG_TEST_FLAG)
#define CSLOG_TEST_DDLOG(frmt, ...) LOG_MAYBE(LOG_ASYNC_ENABLED, ddLogLevel, SHLOG_TEST_FLAG,SHLOG_TEST_LEVEL, nil, __PRETTY_FUNCTION__, frmt, ##__VA_ARGS__)
